...
@section('content')
    ...
    <div class="container mb-4">
        ...
        <div class="row">
            <div class="col-12">
                <img src="{{asset('assets/images/book.jpg')}}" style="width: 100%; height: 350px">
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-6 mt-4">
                ...
                <p><i class="fa fa-phone"></i> 01090572176</p>
                <p><i class="fa fa-phone"></i> 01090572176</p>
                <p><i class="fa fa-phone"></i> 01090572176</p>
            </div>
            <div class="col-12 col-md-6 mt-4">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" novalidate>
                            ...
                            <div class="form-group row">
                                <label for="username" class="col-form-label col-12 col-md-3 font-weight-bold">
                                    Name</label>
                            ...
                            <div class="form-group row">
                                <label for="feedback" class="col-form-label col-12 col-md-3 font-weight-bold">
                                    Feedback</label>
                                <div class="col-12 col-md-9">
                                    <textarea name="feedback" cols="30" rows="3"
