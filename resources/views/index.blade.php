                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        ...
                        <div class="text-center mt-4">
                            <a href="/home"><button class="btn btn-outline-info mt-3">Start Surfing...</button></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-12 text-center">
                        <img src="{{asset('assets/images/ecommerce.jpg')}}" width="370" height="370" class="rounded-circle ">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="text-center">
                        ...
                        <p class="text-muted">
                            ...
                            voluptatibus! Dignissimos ducimus earum explicabo laborum molestias quas tempore, unde ut? Dolor,
                            earum exercitationem impedit in inventore itaque laborum nisi possimus quibusdam quisquam sed sit
                            voluptates.
                        </p>
                        <div class="text-center mt-3">
                           <a href="/home"> <button class="btn btn-outline-info mt-3">Get Started</button></a>
                        </div>
                        <div class="text-center mt-5">
                            <img src="{{asset('assets/images/ecommerce.jpg')}}" width="330" height="330" class="rounded-circle ">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container mb-5">
                ...
                <div class="row">
                    <div class="col-12 col-md-3 mt-3">
                        <img src="{{asset('assets/images/ecommerce.jpg')}}" width="270" height="240" class="rounded">
                    </div>
                    <div class="col-12 col-md-3 mt-3">
                        <img src="{{asset('assets/images/ecommerce.jpg')}}" width="270" height="240" class="rounded">
                    </div>
        ...
        <div class="jumbotron jumbotron-fluid bg-white">
            <div class="container mb-5">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-center">
                            <input type="text" id="subscribe" placeholder="Enter Email Address " class="form-control text-center">
                        </div>
                    </div>
                </div>
            </div>
